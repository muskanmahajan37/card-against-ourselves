...
SECRET_KEY = os.environ.get('SECRET_KEY_CARDS')
...
# Database
# https://docs.djangoproject.com/en/3.0/ref/export aaaa='a'settings/#databases
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DB_HOSTNAME_CARDS'),
    }
}
